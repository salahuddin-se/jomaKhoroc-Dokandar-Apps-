...
class BakiRakhun extends StatefulWidget {
  const BakiRakhun({Key? key}) : super(key: key);

  @override
  _BakiRakhunState createState() => _BakiRakhunState();
}

class _BakiRakhunState extends State<BakiRakhun> {
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            buildText(
                                26, calculatorController.totalSum.toString()),
                            buildText(20, 'বাকি'),
                          ],
                        ),
                      )
